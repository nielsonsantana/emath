...
class PopupSub(PopupPanel):
    def __init__(self, autoHide=None, modal=True, **kwargs):
        ...
        self.caption = HTML()
        self.child = None
        self.setHTML("<b>Subtração de Matrizes.</b>")
...
#        self.imgbtnFazer.addClickListener(fazerProxOperacao)
        ...
        lbcoluna1.addItem("5", value=5); lbcoluna1.addItem("6", value=6);
        ...
        lbcoluna2.addItem("5", value=5); lbcoluna2.addItem("6", value=6);
...
#        self.grid.setWidget(0, 3, self.txtColunas)
    ...
    def validarParametrosMatriz():
        ...
        if (lm1 != lm2):
            Window.alert("A quantidade de linhas da matriz M1 deve ser igual a da matriz M2 para operação de subtração.");
            return False;
        ...
        if (cm1 != cm2):
            Window.alert("A quantidade de colunas da matriz M1 deve ser igual a da matriz M2 para operação de subtração.");
            return False;
