/* start module: componentes.soma.PopupSoma */
$pyjs.loaded_modules['componentes.soma.PopupSoma'] = function (__mod_name__) {
	if($pyjs.loaded_modules['componentes.soma.PopupSoma'].__was_initialized__) return $pyjs.loaded_modules['componentes.soma.PopupSoma'];
	...
	componentes['soma']['PopupSoma'] = $pyjs.loaded_modules["componentes.soma.PopupSoma"];
	componentes['soma']['PopupSoma'].__was_initialized__ = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'componentes.soma.PopupSoma';
	var __name__ = componentes['soma']['PopupSoma'].__name__ = __mod_name__;
	var PopupSoma = componentes['soma']['PopupSoma'];


	componentes['soma']['PopupSoma']['DOM'] = pyjslib['___import___']('pyjamas.DOM', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Factory'] = pyjslib['___import___']('pyjamas.Factory', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Window'] = pyjslib['___import___']('pyjamas.Window', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['PopupPanel'] = pyjslib['___import___']('pyjamas.ui.PopupPanel.PopupPanel', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Grid'] = pyjslib['___import___']('pyjamas.ui.Grid.Grid', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['HTML'] = pyjslib['___import___']('pyjamas.ui.HTML.HTML', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Button'] = pyjslib['___import___']('pyjamas.ui.Button.Button', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['FlexTable'] = pyjslib['___import___']('pyjamas.ui.FlexTable.FlexTable', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['HasHorizontalAlignment'] = pyjslib['___import___']('pyjamas.ui.HasHorizontalAlignment', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['HasVerticalAlignment'] = pyjslib['___import___']('pyjamas.ui.HasVerticalAlignment', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Label'] = pyjslib['___import___']('pyjamas.ui.Label.Label', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['TextBox'] = pyjslib['___import___']('pyjamas.ui.TextBox.TextBox', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['PushButton'] = pyjslib['___import___']('pyjamas.ui.PushButton.PushButton', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['CheckBox'] = pyjslib['___import___']('pyjamas.ui.CheckBox.CheckBox', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['ListBox'] = pyjslib['___import___']('pyjamas.ui.ListBox.ListBox', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Image'] = pyjslib['___import___']('pyjamas.ui.Image.Image', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['DialogBox'] = pyjslib['___import___']('pyjamas.ui.DialogBox.DialogBox', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['Canvas'] = pyjslib['___import___']('pyjamas.Canvas2D.Canvas', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['pyjslib'] = pyjslib['___import___']('pyjslib', 'componentes.soma');
	componentes['soma']['PopupSoma']['VerticalPanel'] = pyjslib['___import___']('pyjamas.ui.VerticalPanel.VerticalPanel', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['HorizontalPanel'] = pyjslib['___import___']('pyjamas.ui.HorizontalPanel.HorizontalPanel', 'componentes.soma', null, false);
	componentes['soma']['PopupSoma']['PararAnimacao'] = function() {
	...
	componentes['soma']['PopupSoma']['PararAnimacao'].__name__ = 'PararAnimacao';

	componentes['soma']['PopupSoma']['PararAnimacao'].__bind_type__ = 0;
	componentes['soma']['PopupSoma']['PararAnimacao'].__args__ = [null,null];
	componentes['soma']['PopupSoma']['IniciarAnimacaoAutomatica'] = function(sender) {
	...
	componentes['soma']['PopupSoma']['IniciarAnimacaoAutomatica'].__name__ = 'IniciarAnimacaoAutomatica';

	componentes['soma']['PopupSoma']['IniciarAnimacaoAutomatica'].__bind_type__ = 0;
	componentes['soma']['PopupSoma']['IniciarAnimacaoAutomatica'].__args__ = [null,null,['sender']];
	componentes['soma']['PopupSoma']['IniciarAnimacaoPassoAPasso'] = function(sender) {

 
        window.parent.init();    
    
	};
	componentes['soma']['PopupSoma']['IniciarAnimacaoPassoAPasso'].__name__ = 'IniciarAnimacaoPassoAPasso';

	componentes['soma']['PopupSoma']['IniciarAnimacaoPassoAPasso'].__bind_type__ = 0;
	componentes['soma']['PopupSoma']['IniciarAnimacaoPassoAPasso'].__args__ = [null,null,['sender']];
	componentes['soma']['PopupSoma']['desfazerProxOperacao'] = function(sender) {
	...
	componentes['soma']['PopupSoma']['desfazerProxOperacao'].__name__ = 'desfazerProxOperacao';

	componentes['soma']['PopupSoma']['desfazerProxOperacao'].__bind_type__ = 0;
	componentes['soma']['PopupSoma']['desfazerProxOperacao'].__args__ = [null,null,['sender']];
	componentes['soma']['PopupSoma']['fazerProxOperacao'] = function(sender) {
	...
	componentes['soma']['PopupSoma']['fazerProxOperacao'].__name__ = 'fazerProxOperacao';

	componentes['soma']['PopupSoma']['fazerProxOperacao'].__bind_type__ = 0;
	componentes['soma']['PopupSoma']['fazerProxOperacao'].__args__ = [null,null,['sender']];
	componentes['soma']['PopupSoma']['PopupSoma'] = (function(){
		var $cls_instance = $pyjs__class_instance('PopupSoma');
		var $cls_definition = new Object();
		var $method;
		$cls_definition.__md5__ = '08fafb2d00ca6fb3a1705824b25b9374';
		$method = $pyjs__bind_method($cls_instance, '__init__', function(autoHide, modal) {
			...
			$pyjs_kwargs_call(componentes['soma']['PopupSoma']['PopupPanel'], '__init__', null, kwargs, [{}, self, autoHide, modal]);
			datasource = null;
			id = null;
			...
			self['setSize']((typeof ($sub1=componentes['soma']['PopupSoma']['Window']['getClientWidth']())==typeof ($sub2=50) && (typeof $sub1=='number'||typeof $sub1=='string')?
				$sub1-$sub2:
				pyjslib['op_sub']($sub1,$sub2)), (typeof ($sub3=componentes['soma']['PopupSoma']['Window']['getClientHeight']())==typeof ($sub4=50) && (typeof $sub3=='number'||typeof $sub3=='string')?
				$sub3-$sub4:
				pyjslib['op_sub']($sub3,$sub4)));
			self['setPopupPosition'](20, 0);
			componentes['soma']['PopupSoma']['DOM']['setAttribute'](self, String('align'), String('center'));
			self.caption = componentes['soma']['PopupSoma']['HTML']();
			self.child = null;
			self['setHTML'](String('\x3Cb\x3ESoma de Matrizes.\x3C/b\x3E'));
			self.dragging = false;
			self.dragStartX = 0;
			self.dragStartY = 0;
			self.imageFechar = $pyjs_kwargs_call(null, componentes['soma']['PopupSoma']['Image'], null, null, [{Size:pyjslib['tuple']([String('32px'), String('32px')]), StyleName:String('gwt-ImageButton')}, String('images/fechar.gif')]);
			self.imgbtnDesfazer = $pyjs_kwargs_call(null, componentes['soma']['PopupSoma']['Image'], null, null, [{Size:pyjslib['tuple']([String('32px'), String('20px')]), StyleName:String('gwt-ImageButton')}, String('images/previous-arrow.png')]);
			self.imgbtnFazer = $pyjs_kwargs_call(null, componentes['soma']['PopupSoma']['Image'], null, null, [{Size:pyjslib['tuple']([String('32px'), String('20px')]), StyleName:String('gwt-ImageButton')}, String('images/next-arrow.png')]);
			self.btnAutomatic = componentes['soma']['PopupSoma']['Button'](String('Automático'), ((($attr1=self['onIniciarAnimacaoAutomatica']) !== null & ($attr2=self).__is_instance__) && typeof $attr1 == 'function'?
						pyjslib['getattr']($attr2, 'onIniciarAnimacaoAutomatica'):
						self['onIniciarAnimacaoAutomatica']));
			self.btnInterativo = componentes['soma']['PopupSoma']['Button'](String('Interativo'));
			self.btnStepByStep = componentes['soma']['PopupSoma']['Button'](String('Passo a passo'), ((($attr3=self['onIniciarAnimacaoPassoAPasso']) !== null & ($attr4=self).__is_instance__) && typeof $attr3 == 'function'?
						pyjslib['getattr']($attr4, 'onIniciarAnimacaoPassoAPasso'):
						self['onIniciarAnimacaoPassoAPasso']));
			self.btnFazer = componentes['soma']['PopupSoma']['Button'](String('fazer \x3E\x3E'), componentes['soma']['PopupSoma']['fazerProxOperacao']);
			self.btnDesfazer = componentes['soma']['PopupSoma']['Button'](String('\x3C\x3C desfazer'), componentes['soma']['PopupSoma']['desfazerProxOperacao']);
			self.btnFechar = componentes['soma']['PopupSoma']['PushButton'](componentes.soma.PopupSoma.imageFechar, componentes.soma.PopupSoma.imageFechar);
			self.btnTestarResposta = componentes['soma']['PopupSoma']['Button'](String('Testar Solução'));
			self.lbVelocidade = componentes['soma']['PopupSoma']['ListBox']();
			...
			lblinha1 = componentes['soma']['PopupSoma']['ListBox']();
			...
			lblinha2 = componentes['soma']['PopupSoma']['ListBox']();
			...
			lbcoluna1 = componentes['soma']['PopupSoma']['ListBox']();
			...
			lbcoluna2 = componentes['soma']['PopupSoma']['ListBox']();
			...
			self.lblStatus = componentes['soma']['PopupSoma']['Label'](String('Label para Status'));
			self['imageFechar']['addClickListener'](((($attr5=self['onFecharPopup']) !== null & ($attr6=self).__is_instance__) && typeof $attr5 == 'function'?
						...
						self['onFecharPopup']));
			self.grid = componentes['soma']['PopupSoma']['Grid'](1, 16);
			...
			self['grid']['setWidget'](0, 15, ((($attr17=self['imageFechar']) !== null & ($attr18=self).__is_instance__) && typeof $attr17 == 'function'?
						...
						self['imageFechar']));
			self['grid']['getCellFormatter']()['setAlignment'](0, 15, ((($attr19=componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_RIGHT']) !== null & ($attr20=componentes['soma']['PopupSoma']['HasHorizontalAlignment']).__is_instance__) && typeof $attr19 == 'function'?
						pyjslib['getattr']($attr20, 'ALIGN_RIGHT'):
						componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_RIGHT']), ((($attr21=componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']) !== null & ($attr22=componentes['soma']['PopupSoma']['HasVerticalAlignment']).__is_instance__) && typeof $attr21 == 'function'?
						pyjslib['getattr']($attr22, 'ALIGN_TOP'):
						componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']));
			self.panel = $pyjs_kwargs_call(null, componentes['soma']['PopupSoma']['FlexTable'], null, null, [{Height:String('100%'), width:String('100%'), BorderWidth:String('0'), CellPadding:String('0'), CellSpacing:String('0')}]);
			...
			self['panel']['getCellFormatter']()['setAlignment'](2, 0, ((($attr27=componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_CENTER']) !== null & ($attr28=componentes['soma']['PopupSoma']['HasHorizontalAlignment']).__is_instance__) && typeof $attr27 == 'function'?
						pyjslib['getattr']($attr28, 'ALIGN_CENTER'):
						componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_CENTER']), ((($attr29=componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']) !== null & ($attr30=componentes['soma']['PopupSoma']['HasVerticalAlignment']).__is_instance__) && typeof $attr29 == 'function'?
						pyjslib['getattr']($attr30, 'ALIGN_TOP'):
						componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']));
			self['panel']['setID'](String('contetepopup'));
			painelhorizontal = componentes['soma']['PopupSoma']['HorizontalPanel']();
			gridinterativa = componentes['soma']['PopupSoma']['FlexTable']();
			painelhorizontal['add'](componentes['soma']['PopupSoma']['HTML'](pyjslib['sprintf'](String('\x3Ccanvas id=\x27%s\x27 datasrc=\x27%s\x27 width=\x27%s\x27 height=\x27%s\x27 style=\x27image-rendering: optimizespeed !important\x3B \x27\x3E\x3C/canvas\x3E'), pyjslib['tuple']([String('soma'), datasource, String('1000px'), String('500px')]))));
			ftInterativo = $pyjs_kwargs_call(null, componentes['soma']['PopupSoma']['FlexTable'], null, null, [{Height:String('100%'), width:String('100%'), BorderWidth:String('0'), CellPadding:String('0'), CellSpacing:String('0')}]);
			gridinterativa = componentes['soma']['PopupSoma']['Grid'](4, 4);
			gridinterativa['setWidget'](0, 0, componentes['soma']['PopupSoma']['HTML'](String('\x3Cb\x3EM1(\x3C/b\x3E\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27linha1\x27 style=\x27width: 25px\x3B height:20px\x3B\x27 maxLength=\x271\x27\x3E\x3Cb\x3E , \x3C/b\x3E')));
			gridinterativa['setWidget'](0, 1, componentes['soma']['PopupSoma']['HTML'](String('\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27coluna1\x27 style=\x27width: 25px\x3Bheight:20px\x3B\x27 maxLength=\x271\x27\x3E\x3Cb\x3E)\x26nbsp\x3B+\x3C/b\x3E')));
			gridinterativa['setWidget'](0, 2, componentes['soma']['PopupSoma']['HTML'](String('\x3Cb\x3EM2(\x3C/b\x3E\x26nbsp\x3B\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27linha2\x27 style=\x27width: 25px\x3B height:20px\x3B\x27 maxLength=\x271\x27\x3E\x3Cb\x3E , \x3C/b\x3E')));
			gridinterativa['setWidget'](0, 3, componentes['soma']['PopupSoma']['HTML'](String('\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27coluna2\x27 style=\x27width: 25px\x3B height:20px\x3B\x27 maxLength=\x271\x27\x3E\x3Cb\x3E)\x26nbsp\x3B=\x3C/b\x3E')));
			gridinterativa['setWidget'](2, 0, componentes['soma']['PopupSoma']['HTML'](String('\x26nbsp\x3B\x26nbsp\x3B\x3Cb\x3E(\x3C/b\x3E\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27n1\x27 style=\x27width: 25px\x3B height:20px\x3B\x27 maxLength=\x271\x27\x3E\x3Cb\x3E)\x26nbsp\x3B+\x3C/b\x3E')));
			gridinterativa['setWidget'](2, 1, componentes['soma']['PopupSoma']['HTML'](String('\x3Cb\x3E(\x3C/b\x3E\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27n2\x27 style=\x27width: 25px\x3B height:20px\x3B\x27 maxLength=\x271\x27\x3E\x3Cb\x3E)\x3C/b\x3E')));
			gridinterativa['setWidget'](2, 2, componentes['soma']['PopupSoma']['HTML'](String('\x3Cb\x3E=\x26nbsp\x3B\x3C/b\x3E\x26nbsp\x3B\x3Cinput type=\x27text\x27 class=\x27gwt-TextBox\x27 id=\x27solucao\x27 style=\x27width: 25px\x3B height:20px\x3B\x27 maxLength=\x271\x27\x3E')));
			...
			ftInterativo['getCellFormatter']()['setAlignment'](4, 0, ((($attr33=componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_CENTER']) !== null & ($attr34=componentes['soma']['PopupSoma']['HasHorizontalAlignment']).__is_instance__) && typeof $attr33 == 'function'?
						pyjslib['getattr']($attr34, 'ALIGN_CENTER'):
						componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_CENTER']), ((($attr35=componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']) !== null & ($attr36=componentes['soma']['PopupSoma']['HasVerticalAlignment']).__is_instance__) && typeof $attr35 == 'function'?
						pyjslib['getattr']($attr36, 'ALIGN_TOP'):
						componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']));
			ftInterativo['getCellFormatter']()['setAlignment'](1, 0, ((($attr37=componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_CENTER']) !== null & ($attr38=componentes['soma']['PopupSoma']['HasHorizontalAlignment']).__is_instance__) && typeof $attr37 == 'function'?
						pyjslib['getattr']($attr38, 'ALIGN_CENTER'):
						componentes['soma']['PopupSoma']['HasHorizontalAlignment']['ALIGN_CENTER']), ((($attr39=componentes['soma']['PopupSoma']['HasVerticalAlignment']['ALIGN_TOP']) !== null & ($attr40=componentes['soma']['PopupSoma']['HasVerticalAlignment']).__is_instance__) && typeof $attr39 == 'function'?
			...
			componentes['soma']['PopupSoma']['PopupPanel']['setWidget'](self, ((($attr43=self['panel']) !== null & ($attr44=self).__is_instance__) && typeof $attr43 == 'function'?
	...
	, 1, [null,['kwargs'],['self'],['autoHide', null],['modal', true]]);
		...
		$method = $pyjs__bind_method($cls_instance, 'onFecharPopup', function(event) {
			...
			self['hide']();
			componentes['soma']['PopupSoma']['PararAnimacao']();
			return null;
		}
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'onIniciarAnimacaoPassoAPasso', function(event) {
			...
			if (pyjslib['bool'](self['validarParametrosMatriz']())) {
				componentes['soma']['PopupSoma']['IniciarAnimacaoPassoAPasso']();
			}
			return null;
		}
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'onIniciarAnimacaoAutomatica', function(event) {
			...
			var onTestarSolucao;
			if (pyjslib['bool'](self['validarParametrosMatriz']())) {
				componentes['soma']['PopupSoma']['IniciarAnimacaoAutomatica']();
			}
	...
	, 1, [null,null]);
		...
		$method = $pyjs__bind_method($cls_instance, 'validarParametrosMatriz', function() {
			...
			if (pyjslib['bool']((pyjslib['bool']($or1=!pyjslib['bool'](lm1))?$or1:!pyjslib['bool'](lm2)))) {
				componentes['soma']['PopupSoma']['Window']['alert'](String('Informe o numero de linhas da matriz M1 e M2.'));
				return false;
			}
			if (pyjslib['bool'](!pyjslib['op_eq'](lm1, lm2))) {
				componentes['soma']['PopupSoma']['Window']['alert'](String('A quantidade de linhas da matriz M1 deve ser igual a da matriz M2 para operação de soma.'));
				return false;
			}
			if (pyjslib['bool']((pyjslib['bool']($or3=(pyjslib['cmp'](lm1, String('5')) == 1))?$or3:(pyjslib['bool']($or4=(pyjslib['cmp'](lm2, String('5')) == 1))?$or4:(pyjslib['bool']($or5=!pyjslib['op_eq'](pyjslib['len'](lm1), 1))?$or5:!pyjslib['op_eq'](pyjslib['len'](lm2), 1)))))) {
				componentes['soma']['PopupSoma']['Window']['alert'](String('A quantidade de linhas da matriz M1 e da matriz M2, deve ser menor ou igual a 5.'));
				return false;
			}
			if (pyjslib['bool']((pyjslib['bool']($or7=!pyjslib['bool'](cm1))?$or7:!pyjslib['bool'](cm2)))) {
				componentes['soma']['PopupSoma']['Window']['alert'](String('Informe o numero de colunas da matriz M1 e M2.'));
				return false;
			}
			if (pyjslib['bool'](!pyjslib['op_eq'](cm1, cm2))) {
				componentes['soma']['PopupSoma']['Window']['alert'](String('A quantidade de colunas da matriz M1 deve ser igual a da matriz M2 para operação de soma.'));
				return false;
			}
			if (pyjslib['bool']((pyjslib['bool']($or9=(pyjslib['cmp'](cm1, String('7')) == 1))?$or9:(pyjslib['bool']($or10=(pyjslib['cmp'](cm2, String('7')) == 1))?$or10:(pyjslib['bool']($or11=!pyjslib['op_eq'](pyjslib['len'](cm1), 1))?$or11:!pyjslib['op_eq'](pyjslib['len'](cm2), 1)))))) {
				componentes['soma']['PopupSoma']['Window']['alert'](String('A quantidade de colunas da matriz M1 e da matriz M2, deve ser menor ou igual a 7.'));
				return false;
			}
			return true;
			return null;
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'onEventPreview', function(event) {
			...
			type = componentes['soma']['PopupSoma']['DOM']['eventGetType'](event);
			if (pyjslib['bool'](pyjslib['op_eq'](type, String('mousedown')))) {
				target = componentes['soma']['PopupSoma']['DOM']['eventGetTarget'](event);
				elem = self['caption']['getElement']();
				event_targets_popup = (pyjslib['bool']($and1=target)?componentes['soma']['PopupSoma']['DOM']['isOrHasChild'](elem, target):$and1);
				if (pyjslib['bool'](event_targets_popup)) {
					componentes['soma']['PopupSoma']['DOM']['eventPreventDefault'](event);
				}
			}
			return componentes['soma']['PopupSoma']['PopupPanel']['onEventPreview'](self, event);
		}
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'onMouseDown', function(sender, x, y) {
			...
			self.dragging = true;
			componentes['soma']['PopupSoma']['DOM']['setCapture'](self['caption']['getElement']());
			self.dragStartX = x;
			self.dragStartY = y;
			return null;
		}
	...
	, 1, [null,null,['self'],['sender'],['x'],['y']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'onMouseUp', function(sender, x, y) {
			...
			self.dragging = false;
			componentes['soma']['PopupSoma']['DOM']['releaseCapture'](self['caption']['getElement']());
			return null;
		}
	, 1, [null,null,['self'],['sender'],['x'],['y']]);
	...
	, 1, [null,null,['self'],['text']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'doAttachChildren', function() {
			...
			componentes['soma']['PopupSoma']['PopupPanel']['doAttachChildren'](self);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method($cls_instance, 'doDetachChildren', function() {
			...
			componentes['soma']['PopupSoma']['PopupPanel']['doDetachChildren'](self);
	...
	, 1, [null,null,['self'],['widget']]);
		...
		return $pyjs__class_function($cls_instance, $cls_definition, 
		                            new Array(componentes['soma']['PopupSoma']['PopupPanel']));
	})();
	return this;
}; /* end componentes.soma.PopupSoma */


/* end module: componentes.soma.PopupSoma */
